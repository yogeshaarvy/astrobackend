...
import { addEditAboutusIntro } from '@/redux/slices/aboutus_introSlice';
...
const Page = () => {
  ...
  const handleImageChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        form.setValue(name as keyof FormData, file as any);
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      // Your API call here
      const result = await dispatch(addEditAboutusIntro(data)).unwrap();
    ...
    <PageContainer>
      <FormUI {...form}>
        <div className="border border-black">
          <form
            className="grid grid-cols-1 gap-6 p-10"
          ...
          >
            <div className="flex gap-10">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-5">
                    <FormLabel className={labelClasses}>Image 1</FormLabel>
                    <FormControl>
                          ...
                          {imagePreviews.image1 ? (
                            <>
                              <img
                                ...
                                alt="Image 1 Preview"
                                className="h-32 max-w-xs object-cover"
                              />
                              <button
                                type="button"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-5">
                    <FormLabel className={labelClasses}>Image 2</FormLabel>
                    <FormControl>
                      <div className="space-y-2">
                        <input
                          type="file"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-5">
                    <FormLabel className={labelClasses}>Image 3</FormLabel>
                    <FormControl>
                      <div className="space-y-2">
                        <input
                          type="file"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mb-5">
                  <FormLabel className={labelClasses}>Heading</FormLabel>
                  <FormControl>
                    <input
                      {...field}

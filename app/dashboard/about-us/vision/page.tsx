...
import { addEditAboutusVision } from '@/redux/slices/aboutus_visionSlice';
...
const Page = () => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      // Your API call here
      const result = await dispatch(addEditAboutusVision(data)).unwrap();
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-5">
                    <FormLabel className={labelClasses}>Image</FormLabel>
                    <FormControl>

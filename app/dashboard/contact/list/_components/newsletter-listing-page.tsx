...
import ContactsTable from './newsletter-tables';
import {
  fetchContactUs,
  IContactUs
} from '@/redux/slices/contact/contactSlice';

export default function ContactsListingPage() {
  ...
  useEffect(() => {
    dispatch(fetchContactUs({ page, pageSize, keyword, field, status, limit }));
  }, [page, pageSize, keyword, field, status, limit, dispatch]);

  const faq: IContactUs[] = cData;
    ...
    <PageContainer scrollable>
      ...
      <div className="mr-5 space-y-4  p-8">
        ...
        <div className="flex items-start justify-between pr-4">
          <Heading title="Contact's Message" description="" />

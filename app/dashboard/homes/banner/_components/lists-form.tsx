...
export default function HomeBannerForm() {
  ...
  const handleDropdownChange = (e: any) => {
    ...
    dispatch(updateHomeBannerListData({ [name]: value }));
  };
              ...
              >
                ...
                <div className="space-y-1">
                  <CustomDropdown
                    ...
                    value={(bData as IHomeBanner)?.banner_type || ''}
                    ...
                    <>
                      <CardContent className="space-y-2 p-0">
                        ...
                        <FormItem className="space-y-3">
                          ...
                          {(bData as IHomeBanner)?.banner_image?.en && (
                            <div className="max-h-48 space-y-4">
                              <FileViewCard
                                existingImageURL={
                                  (bData as IHomeBanner)?.banner_image?.en
                    ...
                    <>
                      <CardContent className="space-y-2 p-0">
                        ...
                        <FormItem className="space-y-3">
                          ...
                          {(bData as IHomeBanner)?.banner_image?.hi && (
                            <div className="max-h-48 space-y-4">
                              <FileViewCard
                                existingImageURL={
                                  (bData as IHomeBanner)?.banner_image?.hi
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      type="color"
                      name="textColour"
                      value={(bData as IHomeBanner)?.textColour || '#ffffff'}
                      onChange={handleInputChange}
                ...
                <div className="space-y-1">
                  ...
                  <Switch
                    className="!m-0"
                    checked={(bData as IHomeBanner)?.active}
                ...
                <div className="space-y-1">
                  <Label htmlFor="readStatus" className="space-x-3">
                    Read Button Status
                  </Label>
                  <Switch
                    className="!m-0"
                ...
                {(bData as IHomeBanner)?.readStatus && (
                  <>
                    ...
                    <div className="!mt-3">
                      ...
                      <Input
                        name="readTitle.hi"
                        placeholder="Enter Hindi Button Title"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="readBackgroundcolor">

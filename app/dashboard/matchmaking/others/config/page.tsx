                          ...
                          <FormItem className="space-y-3">
                            ...
                            {typeof (cData as IMatchMaking)?.mainSection
                              ...
                              <div className="max-h-48 space-y-4">
                                <FileViewCard
                                  existingImageURL={
                                    (cData as IMatchMaking)?.mainSection
                                      ?.bannerImage?.en
                                  }
                                />
                              </div>
                        ...
                        <CardContent className="space-y-2">
                          <div className="space-y-2 pt-0">
                            <FormItem className="space-y-3">
                              ...
                              <FileUploader
                                value={formImageEn ? [formImageEn] : []}
                                onValueChange={(newFiles: any) => {
                                  setformImageEn(newFiles[0] || null);
                                  handleInputChange({
                                    target: {
                                      name: 'section2.formImage.en',
                                      type: 'file',
                                      files: newFiles
                                    }
                                  });
                                ...
                                maxSize={1024 * 1024 * 2}
                              />
                              {typeof (cData as IMatchMaking)?.section2
                                ?.formImage?.en === 'string' && (
                                <div className="max-h-48 space-y-4">
                                  <FileViewCard
                                    existingImageURL={
                                      (cData as IMatchMaking)?.section2
                                        ?.formImage?.en
                                    }
                                  />
                                </div>
                        ...
                        <CardContent className="space-y-2">
                          <div className="space-y-2 pt-0">
                            <FormItem className="space-y-3">
                              <FormLabel>Form Image</FormLabel>
                              <FileUploader
                                value={formImageHi ? [formImageHi] : []}
                                onValueChange={(newFiles: any) => {
                                  setformImageHi(newFiles[0] || null);
                                  handleInputChange({
                                    target: {
                                      name: 'section2.formImage.hi',
                                      type: 'file',
                                      files: newFiles
                                    }
                                  });

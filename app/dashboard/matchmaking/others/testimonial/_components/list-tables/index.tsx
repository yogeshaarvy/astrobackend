...
export default function TestimonialListTable({
  ...
  const columns: ColumnDef<IMatchMakingTestimonial>[] = [
    {
...

    {
      ...
      cell: ({ row }) => {
        const handleToggle = async (checked: boolean) => {
          ...
          try {
            dispatch(updateMatchMakingTestimonialListData(updatedData));
            const result = await dispatch(
              addEditMatchMakingTestimonialList(row.original._id || null)
            ).unwrap();

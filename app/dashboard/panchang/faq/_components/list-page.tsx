...
export default function ListFaqPage() {
  ...
  } = useAppSelector((state) => state.panchangFaq);
  ...
  const handleExport = async () => {
    dispatch(
      ...
      const allFAQList = response.payload?.PanchangFaq;
      const fileType =
    ...
    <PageContainer scrollable>
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <Heading title={`Panchang List Faq (${totalCount})`} description="" />
          <div className="flex gap-5">
            ...
            <Link
              href={'/dashboard/panchang/faq/add'}

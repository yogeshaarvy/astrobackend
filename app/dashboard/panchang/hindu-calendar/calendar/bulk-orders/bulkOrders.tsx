...
} from '@/redux/slices/panchang/bulkOrderCalendar';
...
export default function BulkOrderPage({ empPermissions }: any) {
  ...
  const {
    bulkOrderCalendarState: { loading: uploadBulkOrderLoading, data }
  } = useAppSelector((state) => state.bulkOrderCalendar);
                    ...
                    <div className="rounded-lg border border-yellow-300 bg-yellow-50 p-4">
                      ...
                      <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                          ...
                          EndDate, TitleEnglish, TitleHindi
                        </li>
                        <li>

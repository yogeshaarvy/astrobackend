...
import { addEditPrivacyPolicy } from '@/redux/slices/privacy_policySlice';
...
const PrivacyPolicy: React.FC = () => {
  ...
  const savedDescription =
    typeof window !== 'undefined' ? localStorage.getItem('privacy_policy') : '';
  ...
  useEffect(() => {
    const subscription = form.watch((value) => {
      ...
      localStorage.setItem('privacy_policy', longDescription);
    });

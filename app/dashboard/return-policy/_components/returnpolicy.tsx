...
import { addEditReturnPolicy } from '@/redux/slices/return_policySlice';
...
const ReturnPolicy: React.FC = () => {
  ...
  const savedDescription =
    typeof window !== 'undefined' ? localStorage.getItem('return_policy') : '';
  ...
  useEffect(() => {
    const subscription = form.watch((value) => {
      ...
      localStorage.setItem('return_policy', longDescription);
    });

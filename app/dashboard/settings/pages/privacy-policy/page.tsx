...
import {
  addEditPrivacyPolicysPage,
  fetchPrivacyPolicysPage,
  IPrivacyPolicy,
...
const Page = () => {
  ...
  const {
    privayPolicyState: { loading, data: cData = [] }
  ...
  const handleSubmit = () => {
    try {
      dispatch(addEditPrivacyPolicysPage(null)).then((response: any) => {
        if (!response?.error) {
                      ...
                      <div className=" space-x-2">
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            value={(cData as IPrivacyPolicy)?.metaTitle}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            value={(cData as IPrivacyPolicy)?.metaDescription}
                            onChange={handleInputChange}
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            value={(cData as IPrivacyPolicy)?.metaKeyword}
                            onChange={handleInputChange}
                          />
                        </div>
                      </div>
                            ...
                            <CardContent className="space-y-2">
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  value={
                                    (cData as IPrivacyPolicy)?.title?.en || ''
                                  }
                                  onChange={handleInputChange}
                                />
                              </div>
                              <div className="space-y-1">
                                <CustomTextEditor
                                  ...
                                  value={
                                    (cData as IPrivacyPolicy)?.description
                                      ?.en || ''
                                  }
                                  onChange={(value) =>
                                    handleInputChange({
                            ...
                            <CardContent className="space-y-2">
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  placeholder="Enter your Title"
                                  value={
                                    (cData as IPrivacyPolicy)?.title?.hi || ''
                                  }
                                  onChange={handleInputChange}
                                />
                              </div>

...
import { addEditShippingPolicy } from '@/redux/slices/shipping_policySlice';
...
const ShippingPolicy: React.FC = () => {
  ...
  const savedDescription =
    typeof window !== 'undefined'
      ? localStorage.getItem('shipping_policy')
      : '';
  ...
  useEffect(() => {
    const subscription = form.watch((value) => {
      ...
      localStorage.setItem('shipping_policy', longDescription);
    });
